...
public class SecurityCheckServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (usuario == null || (!username.equalsIgnoreCase(usuario.getLogin()) || !MD5(password).equals(usuario.getSenha()))) {
    ...
    private br.com.customsession.controller.Usuario findByLogin(String username) {
