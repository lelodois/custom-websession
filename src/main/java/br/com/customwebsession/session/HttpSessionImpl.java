...
public class HttpSessionImpl implements HttpSession {
    ...
    public HttpSessionImpl(ServletContext servletContext, String id, long creationTime, long lastAccessedTime, SessionRepo repo, Map<String, String> attributes) {
    ...
    public HttpSessionImpl(ServletContext servletContext, String sessionId, SessionRepo sessionRepo) {
        this(servletContext, sessionId, System.currentTimeMillis(), System.currentTimeMillis(), sessionRepo, Collections.<String, String>emptyMap());
    }
